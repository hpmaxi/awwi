...
import { btnBase, btnDisabled, btnEnabled } from "../tailwind";
  ...
  return (
    <div className="p-4 bg-gray-100 rounded-lg">
      {!evmWalletClient && (
        <>
          <p className="mb-4">
            Connecting to MetaMask is optional but allows you to sign messages
            for making a deterministic schnorr account based on your signed
            message.
          </p>
          <button
            ...
            className={`${btnBase} ${
              isDisabledConnect ? btnDisabled : btnEnabled
            } mb-4`}
          >
      ...
      {evmWalletClient && (
        <>
          ...
          <p className="mb-4">
            ...
            secrets for differents accounts.
          </p>
          <input
            type="text"
            value={messageToSign}
          ...
          <button
            ...
            className={`${btnBase} ${
              isDisabledSignMessage ? btnDisabled : btnEnabled
            }`}
          >
